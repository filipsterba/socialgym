...
const ArgumentSimulator = () => {
    ...
    const [messages, setMessages] = useState([
        { id: 1, sender: 'ai', text: 'Takže ty si myslíš, že máš pravdu? To je roztomilé. Zkus mě přesvědčit.' }
    ]);
    ...
    const handleSend = async () => {
        ...
        const systemPrompt = "Jsi toxický, arogantní debatér. Tvým cílem je vyvést uživatele z míry, zpochybňovat jeho argumenty a být sarkastický. Nikdy nepřiznej chybu. Odpovídej krátce a úderně.";
        ...
        <div className="glass-panel" style={{ height: '600px', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
            <div style={{ padding: '1.5rem', borderBottom: '1px solid var(--glass-border)', background: 'rgba(0,0,0,0.2)' }}>
                <h2 style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                    <Bot color="var(--secondary)" /> Simulátor Hádek (Toxic Mode)
                </h2>
            </div>
            ...
            <div style={{ padding: '1.5rem', borderTop: '1px solid var(--glass-border)', background: 'rgba(0,0,0,0.2)', display: 'flex', gap: '1rem' }}>
                <input
                    ...
                    placeholder="Napiš svůj argument..."
                    style={{
                        flex: 1,
